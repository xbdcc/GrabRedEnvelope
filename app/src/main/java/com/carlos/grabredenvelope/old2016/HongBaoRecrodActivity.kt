...
class HongBaoRecrodActivity : BaseActivity() {
    ...
    private lateinit var mLvHongbaoRecord: ListView
    private lateinit var mTvRecord: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mLvHongbaoRecord = findViewById(R.id.lv_hongbao_record)
